...
const api: BooApi = {
  ...
  library: {
    ...
    transcript: (noteId) => invoke(C.transcript, noteId),
    ...
    pasteImage: (noteId, dataUrl) => invoke(C.pasteImage, noteId, dataUrl),
    pasteMedia: (noteId, file, bytes) => invoke(C.pasteMedia, noteId, file, bytes),
